...
async function boot() {
  ...
  const pitchOutput = commands.pitch.fn()
    ...
    .replace('\n\n\n', '\n\n')
    .replace('  <span class="muted">→ start here:</span> <span class="cmd">whoami</span>', '  <span class="muted">type</span> <span class="cmd">help</span> <span class="muted">to explore</span>');
